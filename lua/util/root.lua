...
function M.setup()
  vim.api.nvim_create_user_command("ShowRoots", show_info, { desc = "Roots for the current buffer" })
  ...
  vim.api.nvim_create_autocmd({ "LspAttach", "BufWritePost", "DirChanged", "BufEnter" }, {
    group = vim.api.nvim_create_augroup("nadako_root_cache", { clear = true }),
